...
- In a terminal, navigate to `TeamsProactiveMessaging`

    ```bash
    # change into project folder
    cd TeamsProactiveMessaging
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `TeamsProactiveMessaging` folder
  - Select `TeamsProactiveMessaging.csproj` file
